...
import { Box } from "@chakra-ui/react"; // <--- ADDED THIS IMPORT

// You might need a Beams.css if there's specific styling for the canvas
// If not, you can remove this import. For example, to set cursor: none;
// import "./Beams.css";
...
// Main BeamsBackground component
export default function BeamsBackground() {
  return (
    <Box
      ...
      w="100%"
      h="100%"
      zIndex="-2" // Even further back than the image background
      sx={{
        '.beams-canvas': { // Target the canvas element within this box
          cursor: 'none', // Optional: Hide cursor over the beams
        }
      }}
    >
      <Beams
